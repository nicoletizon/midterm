...
namespace midterm
{
    ...
    partial void OnNo__of_StockChanging(int value);
    partial void OnNo__of_StockChanged();
    ...
    partial void OnSelling_PriceChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[No. of Stock]", Storage="_No__of_Stock", DbType="Int NOT NULL")]
		public int No__of_Stock
		{
			get
			{
				return this._No__of_Stock;
			}
			set
			{
				if ((this._No__of_Stock != value))
				{
					this.OnNo__of_StockChanging(value);
					this.SendPropertyChanging();
					this._No__of_Stock = value;
					this.SendPropertyChanged("No__of_Stock");
					this.OnNo__of_StockChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Selling Price]", Storage="_Selling_Price", DbType="Money NOT NULL")]
